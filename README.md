...
- `assets/css/photo-backgrounds.css`: original full-page photo backgrounds, directional overlays, warm typography, and slideshow controls. Place copy around each photograph's focal point and keep the photographs as the site's visual identity.
